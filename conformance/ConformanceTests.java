...
public class ConformanceTests {
	...
	public static void main(String[] arguments) {
		...
		Class<? extends Test>[] tests = new Class[] {
				  ...
				  conformance.rmi.SkeletonTest.class, conformance.common.PathTest.class,
				  conformance.rmi.StubTest.class, conformance.rmi.ConnectionTest.class,
				  conformance.rmi.ThreadTest.class, conformance.storage.RegistrationTest.class,
		...
		SeriesReport sreport = series.run(3, System.out);

		// Print the ssssreport and exit with an appropriate exit status.
		sreport.print(System.out);
		System.exit(sreport.successful() ? 0 : 2);
	}
}
